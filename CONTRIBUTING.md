# Contributing to Copier_Python_Default
...
3.  Install the project's dependencies by running `mise install`. This will install the correct versions of Python and pdm as specified in `mise.toml`.
